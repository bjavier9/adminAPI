...
import com.insurance.api.application.service.UserService;
...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsService(UserInputPort userInputPort) {
        return username -> {
            var user = userInputPort.findByUsername(username)
